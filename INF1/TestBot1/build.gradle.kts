...
application {
    ...
    mainClass.set("sk.wz.ady38.Main")
}
...
val fatJar = task("fatJar", type = Jar::class) {
    ...
    manifest {
        attributes["Implementation-Title"] = "TestBot1"
        attributes["Implementation-Version"] = version
        attributes["Main-Class"] = "sk.wz.ady38.Main" // Same mainclass as the application plugin setting
    }
